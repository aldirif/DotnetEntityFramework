...
public class CustomerController : Controller
{
    ...
    [HttpPost]
    public IActionResult Save([Bind("Name, Gender, Address, City")] CustomerEntity request)
    {
        // add ke entity
    ...
    [HttpPost]
    public IActionResult Update([Bind("Id, Name, Gender, Address, City")] CustomerEntity request)
    {
        // update entity
